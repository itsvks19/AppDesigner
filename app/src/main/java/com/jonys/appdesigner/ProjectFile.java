...
public class ProjectFile implements Parcelable {
	...
	public void saveLayout(String text) {
		...
		FileUtil.writeFile(path + "/layout/" + "layout.xml", text);
	}
	...
	public String getLayout() {
		return FileUtil.readFile(path + "/layout/" + "layout.xml");
	}
	...
	public static final Parcelable.Creator<ProjectFile> CREATOR = new Parcelable.Creator<ProjectFile>() {
