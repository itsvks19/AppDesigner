...
public class DimensionUtil {
	...
	public static float parse(String input, Context context) {
		if(input.equals("match_parent")) {
			...
			return TypedValue.applyDimension(dimensMap.get(dimen), number, context.getResources().getDisplayMetrics());
		}
	}
