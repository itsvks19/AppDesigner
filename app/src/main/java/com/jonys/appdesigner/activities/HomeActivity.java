...
import com.jonys.appdesigner.activities.HomeActivity;
...
public class HomeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.drawer.setDrawerListener(
    ...
    private void showAbout() {
        ...
        builder.setMessage(
                "App Designer - lightweight and powerful app to create a beautiful app design");
