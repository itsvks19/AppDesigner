...
public class AttributeInitializer {
	...
	public AttributeInitializer(final Context context, final HashMap<String, ArrayList<HashMap<String, Object>>> attributes, final HashMap<String, ArrayList<HashMap<String, Object>>> parentAttributes) {
		this.context = context;
		this.attributes = attributes;
		this.parentAttributes = parentAttributes;
	}
	
	public AttributeInitializer(final Context context, final HashMap<View, AttributeMap> viewAttributeMap, final HashMap<String, ArrayList<HashMap<String, Object>>> attributes, final HashMap<String, ArrayList<HashMap<String, Object>>> parentAttributes) {
		this.context = context;
	...
	public void applyAttribute(final View target, final String value, final HashMap<String, Object> attribute) {
	...
	public HashMap<String, Object> getAttributeFromKey(String key, ArrayList<HashMap<String, Object>> list) {
